========================================================================
    ACTIVE TEMPLATE LIBRARY : ATLProj-app Project Overview
========================================================================

AppWizard has created this ATLProj-app project for you to use as the starting point for
...
ATLProjapp.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (ATLProjapp.h)
        GUID definitions                                (ATLProjapp_i.c)
        A type library                                  (ATLProjapp.tlb)
        Marshaling code                                 (ATLProjapp_p.c and dlldata.c)

ATLProjapp.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in ATLProjapp.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named ATLProj-app.pch and a precompiled types file named StdAfx.obj.
...
ATLProj-appps.vcxproj
	...
	dlldata.c, ATLProjapp_i.c and ATLProjapp_p.c which are required
	to build the proxy/stub DLL.

ATLProj-appps.vcxproj.filters
